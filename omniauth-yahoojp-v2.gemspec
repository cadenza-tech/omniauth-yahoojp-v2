...
require_relative 'lib/omniauth/yahoojp_v2/version'

Gem::Specification.new do |spec|
  spec.name = 'omniauth-yahoojp-v2'
  spec.version = OmniAuth::YahoojpV2::VERSION
  spec.description = 'Yahoo! JAPAN strategy for OmniAuth'
  spec.summary = 'Yahoo! JAPAN strategy for OmniAuth'
  spec.authors = ['Masahiro']
  spec.email = ['watanabe@cadenza-tech.com']
  spec.license = 'MIT'

  github_root_uri = 'https://github.com/cadenza-tech/omniauth-yahoojp-v2'
